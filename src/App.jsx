...
export default function ModernCV() {
	...
	const content = {
		id: {
			...
			portfolioDesc: [
				"Membangun website portofolio modern dan responsif",
				"Mengoptimalkan tampilan untuk desktop dan mobile",
				"Menggunakan GitHub untuk version control",
			],

			academicDesc: [
				"Mengembangkan tampilan antarmuka aplikasi web",
				"Membuat fitur CRUD dan navigasi responsif",
				"Berkolaborasi dalam pengembangan project akademik",
			],

			landingDesc: [
				"Mendesain landing page modern dan clean",
				"Mengimplementasikan desain menjadi website responsive",
				"Fokus pada user experience dan visual hierarchy",
			],

			educationTitle: "Education",
			degree: "Bachelor of Informatics",
			educationDesc:
				"Fokus pembelajaran pada web development, software engineering, database systems, dan user interface design.",
		...
		en: {
			...
			portfolioDesc: [
				"Built a modern and responsive portfolio website",
			...
			academicDesc: [
				...
				"Implemented CRUD features and responsive navigation",
				"Collaborated in academic project development",
			],

			landingDesc: [
				"Designed a modern and clean landing page",
				"Implemented designs into responsive websites",
			...
			degree: "Bachelor of Informatics",
			educationDesc:
				"Focused on web development, software engineering, database systems, and user interface design.",
	...
	return (
		<div className="relative min-h-screen bg-gray-100 py-6 px-4 flex justify-center text-gray-900 print:bg-white print:py-0 print:px-0">
			...
			<button
				...
				className="fixed top-4 right-4 z-50 px-4 py-2 rounded-lg bg-gray-900 text-white text-sm font-semibold shadow hover:bg-gray-700 transition print:hidden"
			>
				{t.button}
			</button>
					...
					<div className="flex flex-col md:flex-row md:items-start md:justify-between gap-2">
						<div>
							...
							<div className="flex flex-wrap gap-x-4 gap-y-1 mt-3 text-xs text-gray-700">
								...
								<span>
									🔗 linkedin.com/in/purna-aji-wardhana-0609a3407/
								</span>
							</div>
						</div>
						...
						<div className="flex justify-center md:justify-end">
							<img
								src={profile}
								alt="Profile"
								className="w-28 h-32 rounded-2xl object-cover object-top border-4 border-gray-200 shadow-md"
							/>
						</div>
					</div>
				</header>
				...
				<section>
					...
					<div className="flex flex-wrap gap-3 text-sm">
						{[
							...
							<span
								key={skill}
								className="px-4 py-2 rounded-full bg-gray-100 text-gray-700 border border-gray-200"
							>
								{skill}
							</span>
						))}
